...
今日の記事ですが、私が社内でやっていたチーム活動の失敗談を書きます。
当初は、VMwareをプロダクションで利用するために行っていることを、社内の12月配属の新人向けに書こうと思っていましたが、インフラエンジニアっぽい記事が続いているので、それは別で書くことにして、今日はここ1, 2年のチーム活動の反省について書こうと思います。
...
## ケース2 : パダワン制度
### 状況認識
* 新しいツールを作ったり導入したり、新しいアーキテクチャを導入する人が若干名に偏っている
* 該当の若干名が、複数のツールを導入していることがあり、そのそれぞれの質問が1人に来るため質問が集中する
...
* 無事に特定メンバーへの質問を削減
    * 部内勉強会をした時点(期限は切る)から、マスターへの質問はできない、という制度
        * とはいえ、あまり口うるさく言わない
* "専門家感"のある人が増加
...
* マスター/パダワンの負荷が大きい
    * 自由活動としてやっていたので、業務と並行して行っていた
    * きちんと業務として取り入れるべきだった

また、成果物の扱いが曖昧になってしまった、という反省があって、これは会社の文化次第だと思います。

* 成果物の扱いが曖昧で、成果物が社内でしか閲覧できない
    * 内容的には、社内に置く意味はないので、社外公開したい
    * 最終的には社外へ公開しましょう、というのを明示しておかないといけなかった

一方で、個人的な思いとしては、一通り問題の大きい部分は解消できたという思いも半分あって、
最近は、新しいマスターが生まれるような活動を進めたいなぁ、というのが気持ちです。
